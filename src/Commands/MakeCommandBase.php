...
abstract class MakeCommandBase extends GeneratorCommand
{
    /**
    ...
    protected function getDefaultNamespace($rootNamespace)
    {
        ...
        return $this->getConfigNamespace();
    }

    /**
     * Get path to retreive namespace.
     *
     * @return string
     */
    abstract protected function getConfigNamespace();
    ...
    protected function setCustomNamespaceRoots($name)
    {
        ...
        if($rootNamespace = $rootNamespaceArr['path']) {
